module.exports = function(){
    ...
    function getIngredientsPlural(res, mysql, context, complete){
        mysql.pool.query("SELECT sku, name, cost, inventory FROM ingredients", function(error, results, fields){
            if(error){
                res.write(JSON.stringify(error));
                res.end();
            }
            context.IngredientsPlural = results;
            complete();
        });
    }
    ...
    router.get('/', function(req, res){
        ...
        getIngredientsPlural(res, mysql, context, complete);
        function complete(){
            callbackCount++;
            if(callbackCount >= 1){
    ...
    router.post('/', function(req, res){
        ...
        var mysql = req.app.get('mysql');
        var sql = "INSERT INTO ingredients (sku, name, cost, inventory) VALUES (?,?,?,?)";
        var inserts = [req.body.sku, req.body.name, req.body.cost, req.body.inventory];
